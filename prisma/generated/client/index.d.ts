  ...
  */
  ...
  export interface ConfigurationDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
    **/
    createManyAndReturn<T extends ConfigurationCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, ConfigurationCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ConfigurationPayload<ExtArgs>, T, 'createManyAndReturn'>>
